...
from transformers import OwlViTProcessor, OwlViTForObjectDetection, AutoModelForZeroShotObjectDetection, AutoProcessor
...
time.sleep(1)
move_gripper(clients, ORIENTATION_MAP['find_grasp_front'], blocking = True, duration = 1)
time.sleep(1)
