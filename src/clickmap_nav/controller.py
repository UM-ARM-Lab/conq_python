# Class that defines common functions for controlling the robot, 
# This is a base class; child classes might look like an XBox controller class
# (which defines how the xbox buttons map to these functions) or a tablet controller class
# (not that the actual tablet uses these functions)
...
# TODO: Move the Xbox aspect to another file
...
class Controller:
    """Provides Basic functions wrapping Spot API calls.
    ...
    def print_controls():
        print("base Controller class has no default interface")
    ...
    def control_robot():
        """ Controls robot from a ___ controller."""
        raise NotImplementedError('Must be implemented by subclass.')

class XboxController(Controller):
    """XboxController class provides mapping between xbox controller commands and Spot API"""
    def print_controls():
        print(
            textwrap.dedent("""\
